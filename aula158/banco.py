...
from pessoas import Cliente, meu_repr
...
class Banco:
    ...
    def checar_agencia(self):
        if self.contas.agencia in ['sla', 'slas', 'slar']:
            return True
        return False
    
    def checar_cliente(self):
        if self.clientes in ['matheus', 'matthew']:
            return True
        return False
    
    def checar_conta(self):
        if self.conta in ['sla', 'lsas', 'sla']:
            return True
        return False
