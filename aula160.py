...
"""Aprendendo sobre namedtuple, Namedtuple"""

"""namedtuple é uma forma diferente de se ter uma classe que apenas tenha valores imutaveis, onde você tambem pode importar essa classe e criar sua propria classe que herda de Namedtuple, podemdo usar todas as configurações das dataclasses"""
