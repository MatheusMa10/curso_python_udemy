...
def formata_tamanho(tamanho_em_bytes: int, base: int = 1024) -> str:
    ...
    # Original:
    # https://stackoverflow.com/questions/5194057/better-way-to-covert-file-sizes-in-python
...
for root, dirs, files in os.walk(caminho):
    ...
    for file_ in files:
        ...
        # NÃO FAÇA ISSO (CAI APAGAR TUDO DA PASTA)
        # os.unlink(caminho_completo_arquivo)

print(formata_tamanho(1_000))
print(formata_tamanho(1_000_000))
print(formata_tamanho(1_000_000_000))
print(int(math.log(1_000_000, 1024)))

########################################################################################################
# (os.path.getsize) é uma função que recebe um arquivo e retorna o tamanho dele
# (os.path.stat) é uma função que recebe  um arquivo e retorna o status dele e o atributo(.st_size) retorna o tamanho do (stat)
