...
primeira_acao.triggered.connect(lambda: slot_example(status_bar)) # type: ignore # Aqui atribuimos uma função a ação e passamos em uma variavel não nomeada para atrasar a função
